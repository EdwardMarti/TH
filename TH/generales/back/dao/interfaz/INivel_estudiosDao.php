...
interface INivel_estudiosDao {
  ...
  public function select($nivel_estudios);
    /**
     * Lista todos los objetos Nivel_estudios en la base de datos.
     * @return Array<Nivel_estudios> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
