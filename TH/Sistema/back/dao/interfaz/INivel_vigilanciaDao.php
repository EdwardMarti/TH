...
interface INivel_vigilanciaDao {
  ...
  public function select($nivel_vigilancia);
    /**
     * Lista todos los objetos Nivel_vigilancia en la base de datos.
     * @return Array<Nivel_vigilancia> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
