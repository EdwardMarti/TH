...
interface IFechas_particularesDao {
  ...
  public function select($fechas_particulares);
    /**
     * Lista todos los objetos Fechas_particulares en la base de datos.
     * @return Array<Fechas_particulares> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
