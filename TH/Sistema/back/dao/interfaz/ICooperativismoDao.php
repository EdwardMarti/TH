...
interface ICooperativismoDao {
  ...
  public function select($cooperativismo);
    /**
     * Lista todos los objetos Cooperativismo en la base de datos.
     * @return Array<Cooperativismo> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
